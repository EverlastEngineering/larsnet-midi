...
"""
  The following block is the legacy code being cleaned up.
  Reason: dead helper _configure_onset_detection
  Each line is commented out (prefix '# ') so Python's parser
  ignores it. Phase 7 will hard-delete the entire block.
"""
...
"""
  The following block is the legacy code being cleaned up.
  Reason: dead helper _detect_tom_pitches
  Each line is commented out (prefix '# ') so Python's parser
  ignores it. Phase 7 will hard-delete the entire block.
"""
...
"""
  The following block is the legacy code being cleaned up.
  Reason: dead helper _detect_cymbal_pitches
  Each line is commented out (prefix '# ') so Python's parser
  ignores it. Phase 7 will hard-delete the entire block.
"""
...
"""
  The following block is the legacy code being cleaned up.
  Reason: dead helper _detect_snare_pitches
  Each line is commented out (prefix '# ') so Python's parser
  ignores it. Phase 7 will hard-delete the entire block.
"""
...
"""
  The following block is the legacy code being cleaned up.
  Reason: dead helper _create_midi_events
  Each line is commented out (prefix '# ') so Python's parser
  ignores it. Phase 7 will hard-delete the entire block.
"""
...
"""
  The following block is the legacy code being cleaned up.
  Reason: dead helper _run_sensitive_detection
  Each line is commented out (prefix '# ') so Python's parser
  ignores it. Phase 7 will hard-delete the entire block.
"""
...
"""
  The following block is the legacy code being cleaned up.
  Reason: dead helper build_spectral_config_for_stem
  Each line is commented out (prefix '# ') so Python's parser
  ignores it. Phase 7 will hard-delete the entire block.
"""
...
"""
  The following block is the legacy code being cleaned up.
  Reason: dead helper _run_spectral_detection
  Each line is commented out (prefix '# ') so Python's parser
  ignores it. Phase 7 will hard-delete the entire block.
"""
...
"""
  The following block is the legacy code being cleaned up.
  Reason: dead helper _build_events_configured
  Each line is commented out (prefix '# ') so Python's parser
  ignores it. Phase 7 will hard-delete the entire block.
"""
...
"""
  The following block is the legacy code being cleaned up.
  Reason: unreachable tail of process_stem_to_midi (after PGA short-circuit)
  Each line is commented out (prefix '# ') so Python's parser
  ignores it. Phase 7 will hard-delete the entire block.
"""
# 
